...
class GlobalState:
    ...
    backup_directory_path = [rf'\\fsph01\Public\AMS_PHI\12_OPERATIONS\TEST_PRODUCT_ENGINEERING\TPE-Loadboard-Probeshop_Sustaining\Tools\LoadBoardMonitoring\backup',      # Main Backup
